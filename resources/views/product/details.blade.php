                    ...
                    <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <img class="d-block w-100" src="{{asset('assets/img/product-img/product-9.jpg')}}" alt="First slide">
                            </a>
                            </div>
                            ...
                            <div class="carousel-item">
                                <a class="gallery_img" href="{{asset('assets/img/product-img/product-3.jpg')}}">
                                <img class="d-block w-100" src="{{asset('assets/img/product-img/product-3.jpg')}}" alt="Third slide">
                            </a>
                            </div>
                            <div class="carousel-item">
                                <a class="gallery_img" href="{{asset('assets/img/product-img/product-4.jpg')}}">
                                <img class="d-block w-100" src="{{asset('assets/img/product-img/product-4.jpg')}}" alt="Fourth slide">
                            </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-5">
                                <div class="quickview_pro_img">
                                    <img src="{{asset('assets/img/product-img/product-1.jpg')}}" alt="">
                                </div>
                            </div>
            ...
            <div class="col-12">
                <div class="you_make_like_slider owl-carousel">
                    ...
                    <div class="single_gallery_item">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="{{asset('assets/img/product-img/product-2.jpg')}}" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="single_gallery_item">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="{{asset('assets/img/product-img/product-3.jpg')}}" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="single_gallery_item">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="{{asset('assets/img/product-img/product-4.jpg')}}" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="single_gallery_item">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="{{asset('assets/img/product-img/product-5.jpg')}}" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
